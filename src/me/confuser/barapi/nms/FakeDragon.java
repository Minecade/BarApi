...
public abstract class FakeDragon {
    ...
    public FakeDragon(String name, Location loc, int percent, boolean wither) {
        if (wither)
            MAX_HEALTH = 300;
        this.name = name;
    ...
    public FakeDragon(String name, Location loc, boolean wither) {
        if (wither)
            MAX_HEALTH = 300;
        this.name = name;
        this.x = loc.getBlockX();
    ...
    public abstract Object getSpawnPacket(boolean is18);
